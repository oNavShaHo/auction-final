...
export default function Navbar() {
    ...
    return (
        ...
        <ReactModal  className={'max-w-fit max-h-fit items-center'} isOpen={isOpen} onRequestClose={() => setIsOpen(false)}>
            <Login quit = {setIsOpen}></Login>
        </ReactModal>
        ...
        <div className="hidden sm:block flex-shrink flex-grow-0 justify-start px-2">
            <div className="inline-block">
                <div className="inline-flex items-center max-w-full">
                    <button className="flex items-center flex-grow-0 flex-shrink pl-2 relative w-96 border rounded-full px-1  py-1" type="button">
        ...
        <div className="flex justify-end items-center relative">
            ...
            <div className="block">
                <div className="inline relative">
                    <button onClick={()=>setIsOpen(true)} type="button" className="inline-flex items-center relative px-2 border rounded-full hover:shadow-lg">
